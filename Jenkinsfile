...
//        e.g https://github.com/roissticker/events-app-api-server might become https://github.com/MyName/external.git gh repo clone https://github.com/roissticker/events-app-api-server
// variables:
//      roidtc-april2022-u421
...
//      https://github.com/roissticker/events-app-api-server
//      roissticker
//      api-server-image
//      roissticker-1 
...
pipeline {
   ...
   environment {
        ...
        imageName = 'roissticker/api-server-image'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/roissticker/events-app-api-server'
        ...
        stage('Building image') {
         ...
         stage('get k8s credentials') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials roissticker-1 --zone us-central1-c --project roidtc-april2022-u421'
            }
        }     
         stage('update k8s') {
             agent {
